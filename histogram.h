...
Err Histogram1D__check_consistency(Histogram1D* h1, Histogram1D* h2) { 
...
void Histogram1D__add(Histogram1D* h1, Histogram1D* h2, float scale) {
    Err consistency = Histogram1D__check_consistency(h1, h2);
...
void Histogram1D__copy(Histogram1D* to, Histogram1D* from) {
    Err consistency = Histogram1D__check_consistency(to, from);
    switch (consistency) {
    case HISTOGRAM_DIFF_NBINS:
